...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name'=>'permisos.index'])->assignRole($role1);
        ...
        Permission::create(['name'=>'clientes.store'])->assignRole($role1);
        Permission::create(['name'=>'clientes.update'])->assignRole($role1);
