        ...
        <div class="card-body">
            <div class="row input-daterange">
                <div class="col-lg-2 col-sm-2 col-md-2 col-xs-4">
                    <label>Filtrar por fecha de realización</label>
                </div>
                <div class="col-lg-2 col-sm-2 col-md-2 col-xs-4">
                ...
                <table class="table table-striped table-bordered" id="edit-btn">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-priority="5">Fecha de Realización</th>
                            <th data-priority="6">Próxima Actividad</th>
    ...
    dt.ajax.reload();
        ...
        function load_data(from_date = '', to_date = ''){
            $('#edit-btn').DataTable( {
                ...
                ajax: {url:'{{ route('actividades.index') }}',data:{from_date:from_date, to_date:to_date} },
                columns: [
                    {data: 'registro_actividades_id'},
                    {data: 'animal_id'},
                    {data: 'actividades_nombre'},
                    {data: 'registro_actividades_fecha'},
                    {data: 'proxima'},
                    {data: 'pdf'}
                ],
                buttons: [
