...
<div class="col-lg-12">
    <div class="card m-b-30">
        ...
        @endif
        {!! Form::model($enfermedades,['method'=>'PATCH','route'=>['listadoen.update',$enfermedades->enfermedades_id]]) !!}
        {{ Form::token() }}
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="text" name="enfermedades_nombre" value="{{ old('enfermedades_nombre',$enfermedades->enfermedades_nombre) }}" class="form-control" data-toggle="tooltip" data-placement="top"
