        ...
        <div class="card-body">
            <div class="row input-daterange">
                <div class="col-lg-2 col-sm-2 col-md-2 col-xs-4">
                    <label>Filtrar por fecha de ordeño</label>
                </div>
                <div class="col-lg-2 col-sm-2 col-md-2 col-xs-4">
                ...
                <tfoot>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-priority="3">Litros de leche</th>
                            <th data-priority="4">Cantidad de veces ordeñada</th>
                            <th data-priority="5">Fecha de Ordeño</th>
