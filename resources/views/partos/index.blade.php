        ...
        <div class="card-body">
            <div class="row input-daterange">
                <div class="col-lg-2 col-sm-2 col-md-2 col-xs-4">
                    <label>Filtrar por fecha de parto</label>
                </div>
                <div class="col-lg-2 col-sm-2 col-md-2 col-xs-4">
                ...
                <table class="table table-striped table-bordered" id="edit-btn">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <th data-priority="3">Código Hijo</th>
                            <th data-priority="4">Fecha de Parto</th>
                            <th data-priority="5">Complicaciones</th>
                            <th data-priority="6">Descripción</th>
                            <th data-priority="7" class="noVis">Opciones</th>
                        </tr>
                    </thead>
                    <tbody></tbody>
                </table>
...
<script>
    Swal.fire(
      ...
      'la gestación ha sido finalizada y el parto ha sido registrado correctamente.',
      'success'
    )
</script>
@endif
...
<script>
    Swal.fire(
      'Actualización',
      'El parto ha sido actualizado correctamente.',
      'success'
    )
</script>
@endif
