...
<div class="col-lg-12">
    <div class="card m-b-30">
        ...
        @endif
        {!! Form::model($razas,['method'=>'PATCH','route'=>['razas.update',$razas->raza_id]]) !!}
        {{ Form::token() }}
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="text" name="raza_nombre" value="{{ old('raza_nombre',$razas->raza_nombre) }}" class="form-control" data-toggle="tooltip" data-placement="top"
