                            ...
                            <div class="row">
                                <div class="col-12 col-md-7 col-lg-7">
                                    <div class="invoice-logo">
                                        <img src="assets/images/logo2.svg" class="img-fluid" alt="invoice-logo">
                                    </div>
                                ...
                                <div class="col-12 col-md-5 col-lg-5">
                                    <div class="invoice-name">
                                        ...
                                        <p class="mb-1">No : #9988</p>
                                        <p class="mb-0">20 Jan, 2020</p>
                                        <h4 class="text-success mb-0 mt-3">$1410</h4>
                                    </div>
                                </div>
                            </div>
                        </div> 
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-4 col-lg-4">
                                    <div class="invoice-address">
                                        ...
                                        <h6 class="text-muted">Wilson Garcia</h6>
                                        ...
                                        <table class="table table-borderless text-right">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="f-w-7 font-18"><h5>$1410.00</h5></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
