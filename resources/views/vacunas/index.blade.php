        ...
        <div class="card-body">
            <div class="row input-daterange">
                <div class="col-lg-2 col-sm-2 col-md-2 col-xs-4">
                    <label>Filtrar por fecha de vacunación</label>
                </div>
                <div class="col-lg-2 col-sm-2 col-md-2 col-xs-4">
                ...
                <table class="table table-striped table-bordered" id="edit-btn">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-priority="3">Vacuna</th>
                            <th data-priority="4">Fecha de Vacunación</th>
                            <th data-priority="5">Próxima Vacunación</th>
    ...
    dt.ajax.reload();
        ...
        function load_data(from_date = '', to_date = ''){
            $('#edit-btn').DataTable( {
                ...
                ajax: {url:'{{ route('vacunas.index') }}',data:{from_date:from_date, to_date:to_date} },
                columns: [
                    {data: 'registro_vacunas_id'},
                    {data: 'animal_id'},
                    {data: 'vacuna_nombre'},
                    {data: 'registro_vacunas_fecha'},
                    {data: 'proxima'},
                    {data: 'pdf'}
                ],
                buttons: [
                    ...
                    },
                    {
                        ...
                        action: function (e,dt, node, config) {
                            window.location= 'vacunas/create';
                        }
                    }
...
<script>
    function eliminar(event,data) {
            ...
            Swal.fire({
      title: 'Seguro desea eliminar el registro de vacunación '+data,
      ...
      if (result.isConfirmed) {
        let url='{{ route("vacunas.delete",":id") }}'
...
<script>
    Swal.fire(
          'Eliminación',
          'El registro de vacunación ha sido eliminado.',
          'success'
        )
</script>
@endif
...
<script>
    Swal.fire(
          'Creación',
          'El registro de vacunación ha sido creado correctamente.',
          'success'
        )
</script>
@endif
...
<script>
    Swal.fire(
          'Actualización',
          'El registro de vacunación ha sido actualizado correctamente.',
          'success'
        )
</script>
@endif
